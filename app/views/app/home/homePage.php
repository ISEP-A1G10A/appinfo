...
<div class="home-section">
    ...
    <div class="home-section1-bloc">
        <span class="home-bloc-title"><img src="<?php echo new URL("css/home/section1/visualiser.jpg")?>"/>Visualiser</span>
        <p>accédez et personnalisez votre maison</p>
    </div>
    <div class="home-section1-bloc">
        <span class="home-bloc-title"><img src="<?php echo new URL("css/home/section1/economie.jpg")?>"/>Economie</span>
        <p>Suivez votre consommation pour faire des économies </p>
    </div>
    <div class="home-section1-bloc">
        <span class="home-bloc-title"><img src="<?php echo new URL("css/home/section1/securité.jpg")?>"/>Sécurité</span>
        <p>La sécurité est un pilier fondateur de notre entreprise. Notre produit respecte la CNIL</p>
    </div>
    <div class="home-section1-bloc">
        <span class="home-bloc-title"><img src="<?php echo new URL("css/home/section1/ecologie.jpg")?>"/>Ecologie</span>
...
<div id="section2" class="home-section">
    ...
    <p>Contactez nous par email: moongetters@gmail.com<br/>Par téléphone: 0639569547<br/>Nous sommes ouverts tous les jours de 9h à 18h<br/></p>

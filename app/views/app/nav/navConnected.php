    ...
    <div class="navConnected-web-top">
        <span class="navConnected-web-left">
            <a class="navConnected-web-logo-link" href="<?php echo new URL("home/") ?>">
                <img class="navConnected-web-logo" src="<?php echo new URL("img/logos/domisep_mini.png") ?>" alt="logo"/>
        ...
        <span class="navConnected-web-right">
            ...
            <a class="design-btn-raised navConnected-web-disconnect-btn" href="<?php echo new URL("sign-in/") ?>"><?php echo strtoupper($this->s["navs"]["connected"]["connection"])?></a>
        </span>
    </div>
    <div class="design-sideNav">
        <a class="design-sideNav-link<?php echo Regex::urlMatchPattern("profile") ? " current" : "" ?>" href="<?php echo new URL("profile/")?>">
        ...
        <!--<div>--> <!--class="navConnected-web-houses"-->
            ...
            ?>
        <!--</div>-->
        <a class="design-sideNav-link<?php echo Regex::urlMatchPattern("help") ? " current" : "" ?>" href="<?php echo new URL("help/")?>">

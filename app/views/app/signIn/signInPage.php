<div class="signIn">
    <div class="design-form signIn-form">
        ...
        <form action="<?php echo new URL("form/connection/") ?>" method="post" class="design-form-inputs">
            <input name="email" class="design-input-classic" type="text" placeholder="Email"><br>
            <input name="password" class="design-input-classic" type="password" placeholder="Password"><br>
